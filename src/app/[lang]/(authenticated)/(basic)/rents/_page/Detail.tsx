              ...
              <Table>
                ...
                <TableBody className="text-left">
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      {data.RentDetail.is_paid ? "true" : "false"}
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell className="font-medium">
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      {localeCurrency(
                        data.RentDetail.estimated_final_price,
                        lang
                      )}
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    ...
                    <TableCell>
                      {localeCurrency(
                        data.RentDetail.estimated_normal_price,
                        lang
                      )}
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell className="font-medium">
                      Estimated saved price
                    </TableCell>
                    <TableCell>
                      {localeCurrency(
                        data.RentDetail.estimated_saved_price,
                        lang
                      )}
                    </TableCell>
                  </TableRow>
