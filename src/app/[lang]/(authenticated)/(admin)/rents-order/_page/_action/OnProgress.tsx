...
export default function OnProgress({text,data}:{text:string,data:RentType}) {
  ...
  return (
    <>
      <Dialog>
        ...
        <DialogContent>
          <DialogHeader>
            <DialogTitle>On progress.</DialogTitle>
            <DialogDescription>
              Are you sure you want to change the status to on progress?
            </DialogDescription>
          </DialogHeader>
          <form onSubmit={handleSubmit(onSubmit)}>
            <Input type="hidden" {...register("status")} defaultValue="OnProgress"/>
          <DialogFooter>
